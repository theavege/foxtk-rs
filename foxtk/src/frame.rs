...
impl super::ObjectExt for HorizontalFrame {
    fn as_raw(&self) -> foxtk_sys::ObjectPtr {
        self.0
    }
    fn from_raw(ptr: foxtk_sys::ObjectPtr) -> Self {
...
impl super::IdExt for HorizontalFrame {}
impl super::WindowExt for HorizontalFrame {}
impl super::VerticalFrameExt for HorizontalFrame {}
