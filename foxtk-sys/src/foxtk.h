...
//~ FXId
    ObjectPtr* fx_id_get_app(ObjectPtr* wgt);
        ...
        typedef void* FXID_t;
    #else
        typedef unsigned long FXID_t;
    #endif
    FXID_t fx_id_get_id(ObjectPtr* wgt);
...
//~ FXCanvas mouse callback
    typedef long (*CMouseCb)(ObjectPtr* widget, int event_code, int x, int y, void* context);
...
//~ FXMenuButton.h
    ...
    void fx_menu_button_style(ObjectPtr* wgt, unsigned int style);
    void fx_menu_button_popup_style(ObjectPtr* wgt, unsigned int style);
    void fx_menu_button_attachment(ObjectPtr* wgt, unsigned int attachment);
